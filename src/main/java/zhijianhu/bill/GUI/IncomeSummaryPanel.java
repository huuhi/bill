...
public class IncomeSummaryPanel extends JPanel {
    ...
    public IncomeSummaryPanel() {
        ...
        categoryComboBox = new JComboBox<>(new String[]{"全部", "工资", "奖金", "其他"});
        ...
        Object[][] data = {
            {"2024-12-01", "工资", 5000, "null"},
            {"2024-12-15", "奖金", 1000, "null"},
            {"2024-12-31", "其他", 500, "null"}
        };
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("收入汇总");
            frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            frame.setSize(800, 600);
            frame.setLocationRelativeTo(null);
            frame.add(new IncomeSummaryPanel());
